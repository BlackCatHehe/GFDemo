...
- (void)photoView:(HXPhotoView *)photoView changeComplete:(NSArray<HXPhotoModel *> *)allList photos:(NSArray<HXPhotoModel *> *)photos videos:(NSArray<HXPhotoModel *> *)videos original:(BOOL)isOriginal {
    ...
    [self.toolManager getSelectedImageList:allList requestType:HXDatePhotoToolManagerRequestTypeOriginal success:^(NSArray<UIImage *> *imageList) {
        ...
        NSSLog(@"获取的图片:%@", imageList);
        [[NSNotificationCenter defaultCenter]postNotificationName:@"SelectedPics" object:imageList];
    } failed:^{
       [[NSNotificationCenter defaultCenter]postNotificationName:@"SelectedPics" object: nil];
    }];
