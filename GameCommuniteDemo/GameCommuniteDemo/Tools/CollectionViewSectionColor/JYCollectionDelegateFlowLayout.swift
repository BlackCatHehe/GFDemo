//
//  JYCollectionDelegateFlowLayout.swift
//  NationalFace
//
...
protocol JYCollectionDelegateFlowLayout: UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, backgroundColorForSectionAt section: Int) -> UIColor
}

extension JYCollectionDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, backgroundColorForSectionAt section: Int) -> UIColor {
...
class JYCollectionViewFlowLayout: UICollectionViewFlowLayout {
    ...
    override func prepare() {
        ...
        guard let numberOfSections = self.collectionView?.numberOfSections,
            let delegate = self.collectionView?.delegate as? JYCollectionDelegateFlowLayout
            else {
                return
        }
