...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DYFoldLabel/DYFoldLabel.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LZImageBrowser/LZImageBrowser.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/PlaceholderTextView/PlaceholderTextView.framework"
